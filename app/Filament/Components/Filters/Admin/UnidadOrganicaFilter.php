...
class UnidadOrganicaFilter
{
     ...
     * @throws Exception
     */
    public function getUnidadOrganicaSelectFilter(): SelectFilter
    {

        $params = [
            'make' => 'servicio_id',
            'label' => 'Filtrar por la unidad orgánica',
        ];

        return new MiSelectFilter()->getSelectFilterBase($params)
            ->options(new UnidadOrganicaRepository()->getArrayUnidadesOrganicas(false));
    }
