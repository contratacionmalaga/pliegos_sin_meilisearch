...
class EstadisticaSumAdjudicacionesPorTipoContratoChart extends \App\Filament\Widgets\BaseChartWidget
{
    protected static ?string $chartId = 'EstadisticaSumAdjudicacionesPorTipoContratoChar';

//    protected ?string $heading = 'Importe total de adjudicaciones por tipo de contrato';
