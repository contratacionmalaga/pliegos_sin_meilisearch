...
class EstadisticaSumExpedientesPorTipoOrgContratacionChart extends \App\Filament\Widgets\BaseChartWidget
{
    protected static ?string $chartId = 'EstadisticaSumExpedientesPorTipoOrganoContratacionChar';

//    protected ?string $heading = 'Importe total de expedientes por tipo de órgano de contratación';
