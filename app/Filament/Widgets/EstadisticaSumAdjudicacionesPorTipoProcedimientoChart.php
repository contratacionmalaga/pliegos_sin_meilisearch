...
class EstadisticaSumAdjudicacionesPorTipoProcedimientoChart extends \App\Filament\Widgets\BaseChartWidget
{
    protected static ?string $chartId = 'EstadisticaSumAdjudicacionesPorTipoProcedimientoChar';

//    protected ?string $heading = 'Importe total de adjudicaciones por tipo de procedimiento';
