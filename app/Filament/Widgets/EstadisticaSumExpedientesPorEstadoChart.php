...
class EstadisticaSumExpedientesPorEstadoChart extends \App\Filament\Widgets\BaseChartWidget
{
    protected static ?string $chartId = 'EstadisticaSumExpedientesPorEstadoChar';

//    protected ?string $heading = 'Importe total de expedientes por estado del contrato';
