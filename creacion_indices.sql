...
CREATE INDEX placsp_documentos_document_reference_type_IDX USING BTREE ON laravel_pliegos.placsp_documentos (document_reference_type);
CREATE INDEX placsp_documentos_party_name_organo_contratacion_IDX USING BTREE ON laravel_pliegos.placsp_documentos (party_name_organo_contratacion);
CREATE INDEX placsp_documentos_updated_IDX USING BTREE ON laravel_pliegos.placsp_documentos (updated);
...
-- placsp_lotes
CREATE INDEX placsp_lotes_party_name_organo_contratacion_IDX USING BTREE ON laravel_pliegos.placsp_lotes (party_name_organo_contratacion);
CREATE INDEX placsp_lotes_updated_IDX USING BTREE ON laravel_pliegos.placsp_lotes (updated);
